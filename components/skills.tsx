...
import imgc from "./images/exp1.svg";
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          There are a lot of cool cloud computing like AWS,Azure Google Cloud ....
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Use Cloud.</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
...
const items = [
  {
    ...
    description: (
      <span className="text-sm">
        Strong knowledge in development of apps through Java (Android studio)
      </span>
    ),
    header: <SkeletonOne />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        I have a deep knowledge in HTMl,CSS,Javascript,Typescript
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
